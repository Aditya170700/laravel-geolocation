      	...
      	if (window.action == "submit") {
            ...
            function addRouteShapeToMap(route){
                  let linestring = new H.geo.LineString(),
                      ...
                      startPoint, endPoint, polyline, routeline, svgStartMark, iconStart, startMarker, svgEndMark, iconEnd, endMarker;
                  ...
                  // <svg width="1000px" height="1000px" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg">
                  //                         <g class="layer">
                  //                               <title>Layer 1</title>
                  //                               <polygon cx="96.5" cy="144.5" fill="#0000bf" id="svg_1" orient="point" point="5" points="96.5,110.86800465165483 104.40735634837054,133.61645768337982 128.48592833205197,134.10714188262216 109.29437133282079,148.65714324695114 116.26839087092635,171.70885579155043 96.5,157.95279813933806 76.73160912907366,171.70885579155043 83.70562866717921,148.65714324695114 64.51407166794803,134.10714188262216 88.59264365162946,133.61645768337982 96.5,110.86800465165483 104.40735634837054,133.61645768337982 " r="33.632" r2="13.4528" shape="star" stroke="#0505ad" stroke-width="5" strokeWidth="5" strokecolor="#000000" transform="rotate(-1.30824 96.5 141.288)"/>
                  //                         </g>
                  //                 </svg>
                  ...
                  // let test = new H.map.Group();
                  // test.addObjects([polyline, routeline, startMarker, endMarker]);
                  map.addObjects([polyline, routeline, startMarker, endMarker]);

                  // and zoom to its bounding rectangle
                  // untuk menjaga polyline agar tidak rusak saat dizoom
            ...
            if (window.action == 'direction') {
                  ...
                  Number.prototype.toMMSS = function(){
                        ...
                        return Math.floor(this / 3600) + ' hours ' + (this % 60) + ' minutes';
                  }
